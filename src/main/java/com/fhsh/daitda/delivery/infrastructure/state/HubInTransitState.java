...
public class HubInTransitState implements DeliveryState {

    /*
    * 허브 대기 중 -> 허브 이동 (도착지 허브 도착 완료)
    * */
    ...
    public void arrive(Delivery delivery, String receiverEmail) {
        delivery.changeStatus(DeliveryStatus.HUB_ARRIVED);
        // TODO: messageType 슬랙 담당자 확인 후 수정 필요
        slackClient.sendMessage(
                receiverEmail,
                String.format("[알림] 주문번호(%s)의 배송이 목적지 허브에 도착했습니다.", delivery.getOrderId()),
                delivery.getOrderId(),
                "HUB_ARRIVED"
        );
    }
    ...
    public DeliveryStatus getStatus() {
        return DeliveryStatus.HUB_IN_TRANSIT;
    }
}
