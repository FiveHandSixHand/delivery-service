...
public class HubArrivedState implements DeliveryState {
    ...
    public void startDelivering(Delivery delivery, String receiverEmail) {
        delivery.changeStatus(DeliveryStatus.DELIVERING);
        // TODO: messageType 슬랙 담당자 확인 후 수정 필요
        slackClient.sendMessage(
                receiverEmail,
                String.format("[알림] 주문번호(%s)의 배송이 시작되었습니다.", delivery.getOrderId()),
                delivery.getOrderId(),
                "DELIVERY_START"
        );
    }
    ...
    public DeliveryStatus getStatus() {
        return DeliveryStatus.HUB_ARRIVED;
    }
}